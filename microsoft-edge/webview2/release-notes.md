...
ms.openlocfilehash: 9cec5cd348a0b4aaaef7978ac1a07a2d43f1ecd6
ms.sourcegitcommit: b0604ac0d43cef4df04256bed3a375febc45d1a4
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/04/2021
ms.locfileid: "12157220"
---
...
*   修复了在附加事件处理程序时 [AllowSingleSignOnUsingOSPrimaryAccount](/microsoft-edge/webview2/reference/win32/icorewebview2environmentoptions#get_allowsinglesignonusingosprimaryaccount) 无法正常使用 WebView2 `WebResourceRequested` 的问题。 此更改特定于运行时。  ([问题 #1183](https://github.com/MicrosoftEdge/WebViewFeedback/issues/1183)) 。
...
*   修复了在选择切换焦点时导致 WebView2 控件在 Microsoft Visual Studio Tools for Office 中 `Tab` 崩溃Office。   ([问题 589](https://github.com/MicrosoftEdge/WebViewFeedback/issues/589) 和问题 [#933](https://github.com/MicrosoftEdge/WebViewFeedback/issues/933)) 。  此更改特定于运行时。
...
*   在 WebView2 环境选项上添加了 [AllowSingleSignOnUsingOSPrimaryAccount](/microsoft-edge/webview2/reference/win32/icorewebview2environmentoptions?view=webview2-0.9.622&preserve-view=true#get_allowsinglesignonusingosprimaryaccount) 属性，以打开 WebView 的条件访问。
...
*   添加了实验 [性 WebResourceResponseReceived](/microsoft-edge/webview2/reference/win32/icorewebview2experimental?view=webview2-0.9.538-prerelease&preserve-view=true#add_webresourceresponsereceived) 事件，该事件在 WebView 接收并处理来自 WebResource 请求的响应之后运行。  响应对象中包含身份验证标头（如果有）。
...
*   有关生成 Windows Forms 应用的信息，请导航到[WinForms](./get-started/winforms.md)应用中的 WebView2 入门和 Windows [Forms](/dotnet/api/microsoft.web.webview2.winforms)特定 API 的 WebView2 Windows Forms Reference。
...
*   > [!IMPORTANT]
    > 公告 **：今后**，WebView2 团队会发布两个程序包：一个包含实验性 API (的预发布程序包，让你试用) 和一个稳定的版本包（具有稳定的 API (）来) 。  若要了解差异，请导航到了解[浏览器版本和 WebView2。](./concepts/versioning.md)
...
*   向 `.tlb` 文件包NuGet Issue [#22](https://github.com/MicrosoftEdge/WebViewFeedback/issues/22) (文件) 。

...
ms.date: 11/05/2021
ms.openlocfilehash: 32f79edf0bad00595286555e12095b61ec121fd3
ms.sourcegitcommit: ae41e2c0ca42fb7eac73824c828305c7b13b4203
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/09/2022
ms.locfileid: "12345882"
---
# <a name="get-started-with-webview2-in-winui-2-uwp-apps-public-preview"></a>使用 WinUI 2 中的 WebView2 (UWP) 应用 (公共预览版) 

本文将介绍在 WinUI 2 和 UWP (创建第一) WebView2 应用，并了解 WebView2 的主要功能。


<!-- ====================================================================== -->
## <a name="api-reference"></a>API 参考

有关适用于 UWP 的 WebView2 API 的详细信息，请参阅 WinRT API 参考：
...
WinUI 2 仅支持 UWP。  有关所有平台的 API 的信息，请参阅 [WebView2 API 参考](../webview2-api-reference.md)。


<!-- ====================================================================== -->
## <a name="use-a-preview-channel-of-microsoft-edge"></a>使用预览频道Microsoft Edge

[WinUI 2](https://www.nuget.org/packages/Microsoft.UI.Xaml/2.8.0-prerelease.210927001) 程序包依赖于预发布 WebView2 程序包。  为了完全实现 API 兼容性，请使用预览浏览器通道作为运行时，如预览版的 Beta、Dev 或 Canary Microsoft Edge。


<!-- ====================================================================== -->
## <a name="features-with-limited-functionality"></a>功能受限的功能

WebView2 WinUI 2 控件正在积极开发中。  以下功能缺失或出问题：
...
<!-- ====================================================================== -->
## <a name="step-1---set-up-prerequisites"></a>步骤 1 - 设置先决条件

1. 安装[Microsoft Visual Studio 2019 版本 16.9](/visualstudio/releases/2019/release-notes-v16.9) 或更高版本。  接受默认值。

1. 默认情况下，Visual Studio代码编辑器中不会显示行号。  若要启用行号，请选择 **"工具** > **""选项"** > **"文本编辑器"** > **"所有语言** > **""行号"**。  然后单击" **确定"**。


<!-- ====================================================================== -->
## <a name="step-2---install-uwp-tools"></a>步骤 2 - 安装 UWP 工具
...
1. 在右侧，**** > 展开安装详细信息通用 Windows **平台开发**，然后单击 **C++ (v142) 通用 Windows 平台工具**。

   "**修改 Visual Studio 2019"** 对话框显示卡和安装详细信息。  通用平台开发Windows包括和可选项。
...
1. 在Visual Studio中，选择 **"文件** > **"** > **"新建Project"**。  或使用项目的启动屏幕Visual Studio，然后选择"**新建项目"**。  将 **打开"新建项目** "对话框。
...
1. 在应用模板列表中，单击"空白**应用 (通用Windows) "**。
   ...
   将显示 **"新建项目** "对话框。  筛选条件以红色突出显示。  空白应用 (通用Windows) 卡以红色突出显示。

   :::image type="content" source="media/winui2-getting-started-create-project.png" alt-text="&quot;创建新项目&quot;对话框将显示空白应用 (通用Windows) 卡片。" lightbox="media/winui2-getting-started-create-project.png":::

1. 单击“下一步”****。

   对于**空白应用和**通用应用，将显示"配置新项目 (**Windows) **。

   :::image type="content" source="media/winui2-getting-started-config-new-project.png" alt-text="&quot;配置新项目&quot;对话框显示&quot;空白应用&quot;和&quot;通用 (文本框Windows) 。" lightbox="media/winui2-getting-started-config-new-project.png":::
...
1. 单击 **"是**"**，然后关闭**设置窗口。
   ...
   :::image type="content" source="media/new-project-created.msft.png" alt-text="生成的项目。" lightbox="media/new-project-created.msft.png":::
...
1. 将显示 **"许可证** 接受"对话框。  单击 **"我接受"**。  将显示 `readme.txt` 文件。
...
1. 保存文件。 在代码 `MainPage.xaml` 编辑器中的文件上方，将显示 WebView2 内容的预览。
   ...
   :::image type="content" source="media/winui2-getting-started-preview-webview2-content.png" alt-text="WebView2 内容的预览。" lightbox="media/winui2-getting-started-preview-webview2-content.png":::

### <a name="build-and-test-the-webview2-project"></a>生成和测试 WebView2 项目

1. 单击 **"调试** > **""开始调试"**。  应用程序窗口将打开，并简要显示 WebView2 WebUI 网格。

   :::image type="content" source="media/winui2-getting-started-webview2-grid.png" alt-text="网格在调试期间短暂显示。" lightbox="media/winui2-getting-started-webview2-grid.png":::

1. 片刻之后，应用窗口在 WebUI 2 必应 WebView2 控件中显示网站。

   具有 WebView2 控件的示例应用将显示必应网站，http://www.bing.com:

   :::image type="content" source="media/winui2-getting-started-webview2-with-content.png" alt-text="示例应用显示必应网站。" lightbox="media/winui2-getting-started-webview2-with-content.png":::

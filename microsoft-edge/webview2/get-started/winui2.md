...
ms.date: 04/27/2022
ms.openlocfilehash: a3cf293511a65c33a298825a97eaa689b15dc681
ms.sourcegitcommit: 61d541b18043bdc4b2a6d65d6eb7422d54da2c2f
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/09/2022
ms.locfileid: "12639957"
---
...
* GitHub 的相应入门示例：无;WinUI 3：[在 WinUI3 中使用 WebView2 入门 (WinUI_Sample/WinUI_Sample.sln) ](https://github.com/MicrosoftEdge/WebView2Samples/tree/main/GettingStartedGuides/WinUI3_GettingStarted#readme)
...
<!-- ====================================================================== -->
## <a name="step-1---download-a-preview-channel-of-microsoft-edge"></a>步骤 1 - 下载 Microsoft Edge 的预览频道

为了实现 **Microsoft.UI.Xaml** (WinUI 2) 包和 WebView2 的完全 API 兼容性，本教程使用 WebView2 SDK 的 _预发行_ 版本以及 Microsoft Edge 的预览频道。   (本教程不使用其他受支持的组合，即 WebView2 SDK 的 _发布_ 版本 + WebView2 Runtime.) 

1. 如果尚未下载任何 [Microsoft Edge 预览体验成员 (预览) 频道](https://www.microsoftedgeinsider.com/download) (Beta、Dev 或 Canary) ， (OS) ：
   *  Windows 7
   *  Windows 8.1
   *  Windows 10
   *  Windows 11
...
本教程需要 Visual Studio 2019 版本 16.9 或更高版本。  不支持 Visual Studio 2017。  如果需要有关 Visual Studio 2019 版本 16.9 的信息，请在新窗口或选项卡中查看 [Microsoft Visual Studio 2019 版本 16.9](/visualstudio/releases/2019/release-notes-v16.9)。
...
1. 选择 **“工具** > **获取工具”和“功能**”。  **将打开Visual Studio 安装程序**窗口，然后在其中打开 **“修改 Visual Studio**”窗口：
...
1. 关闭**Visual Studio 安装程序**窗口。
   ...
   Visual Studio 窗口仍然为空。


<!-- ====================================================================== -->
## <a name="step-4---create-a-uwp-app"></a>步骤 4 - 创建 UWP 应用

1. 如果 Visual Studio 处于打开状态，请选择 **“文件** > **新建** > **项目**”。
...
1. 单击 **“创建”** 按钮。
   ...
   将显示“**新建通用 Windows 平台项目**”对话框：

   ![“新建通用 Windows 平台项目”对话框。](media/winui2-new-univ-win-plat-project.png)
...
1. 在右侧的 **“版本** ”下拉列表中，确保选择了 **最新预发行版** ：
   ...
   ![已选择 WebView2 SDK 预发行版的 NuGet 包管理器。](media/winui2-nuget-pkg-mgr-webview2.png)
...
1. 如果 **NuGet 包管理**器面板未打开：在解决方案资源管理器中，右键单击项目 (而不是它上面的解决方案节点) ，然后选择 **“管理 NuGet 包**”。
...
*  文件选取器对话框。
*  背景音频。
*  打印到 PDF。<!--todo: has issues?  dated info?  not implemented?-->
*  打印预览版。<!--todo: has issues?  dated info?  not implemented?-->
*  在 WinRT `AddHostObject`)  (添加 COM 对象。
*  Playready DRM。
*  20H2 之前 Windows 设备上的服务工作者。

...
1.  安装Windows库。  
    ...
    1.  在右侧窗口中，选择"安装 **"。**  NuGet将库下载到计算机。  
        ...
        > [!NOTE]
        > 实现[Windows库][GithubMicrosoftWilMain]和 Windows[运行时 C++ 模板][CppCxWrlTemplateLibraryVS2019]库是可选的，因此对于此示例而言，使用 COM 更简单。  
...
在回调中，设置一些设置，调整 WebView 的大小以使用父窗口的 100%，然后导航到必应。  

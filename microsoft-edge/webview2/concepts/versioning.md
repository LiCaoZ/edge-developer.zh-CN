...
ms.date: 08/03/2021
ms.openlocfilehash: dcb9575de36d376ee8fd06189596dea270c341de
ms.sourcegitcommit: 62f55a8303644d4d3f2ea29e624efcc54f465aa1
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/20/2022
ms.locfileid: "12521771"
---
...
如果在客户端上阻止更新 WebView2 运行时，请确保知道应用所需的 WebView2 运行时的最小内部版本号。  请参阅 [Microsoft Edge WebView2](https://developer.microsoft.com/microsoft-edge/webview2/)。  支持 SDK 正式发布所需的最低运行时版本 (内部版本 616) 早于最新运行时。  最新的运行时支持最新 SDK 版本中的所有 API。

...
ms.date: 11/19/2021
ms.openlocfilehash: a436f848e487611fd515b6e3e286ecfcae8221c2
ms.sourcegitcommit: 82de2fa19bf9c925ff5faafe8be6b24d21767e03
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/10/2022
ms.locfileid: "12346580"
---
...
Microsoft Edge版本 96 计划于 2021 年 11 月 18 日成为 Stable 版本。  Microsoft Edge版本 97 之后，版本 97 将从 Dev 转移到 Beta 预览版。
...
Microsoft Edge 94 在 2021 年 9 月 23 日移动到 Stable。 此发布周期很短，只是<!-- em dash --> 3 周Microsoft Edge 93 Stable 到 Microsoft Edge 94 Stable，因为我们贴靠到新的 [4 周发布周期](https://blogs.windows.com/msedgedev/2021/03/12/new-release-cycles-microsoft-edge-extended-stable/)。  这一新的发布节奏与加速 Chrome 发布周期Chromium里程碑的新节奏[相匹配](https://blog.chromium.org/2021/03/speeding-up-release-cycle.html)。
...
了解有关在渐进 Web 应用和 PWA 中实验功能 ([窗口控件覆盖) ](../how-to/window-controls-overlay.md)。
...
若要详细了解如何试验 URL 处理程序，请通过渐进 [式 Web 应用和 PBA ](../how-to/handle-urls.md) (实验) 。
...
若要详细了解如何将协议处理程序与 PWA一起使用，PWA[渐进式 Web 应用中的实验功能 (PWA) ](../how-to/handle-protocols.md)。

...
ms.date: 01/24/2022
ms.openlocfilehash: 4f313d8ba5a92a72230d1d45c4ab3345f7b52d7f
ms.sourcegitcommit: 56d88962483dab8374f3dccb67f546df1c26ec17
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/20/2022
ms.locfileid: "12522074"
---
...
| 默认情况下忽略修改`document.domain` | v106 | | 该 `document.domain` 属性在历史上可以设置为放宽同一源策略，并允许来自网站的子域进行交互。 默认情况下将禁用此行为，这样设置属性 `document.domain` 将不起作用。  有关详细信息和解决方法，请参阅[Microsoft Edge将禁用修改 document.domain](/deployedge/edge-learnmore-origin-keyed-agent-cluster)。

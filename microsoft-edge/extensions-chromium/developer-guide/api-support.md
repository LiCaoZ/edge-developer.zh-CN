...
ms.openlocfilehash: e6a6e543e0e8d2b67d2b57f931e62c66dd92d776
ms.sourcegitcommit: 97b32870897c702eed52d9fbbd13cfff2046ad87
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/22/2021
ms.locfileid: "12108554"
---
...
| [contentSettings](https://developer.chrome.com/extensions/contentSettings) | 通常，内容设置允许您在每个网站上自定义Microsoft Edge网站的行为，而不是全局行为。 更改控制网站是否可以使用 Cookie、JavaScript 和插件等功能的设置。 |
...
| [fontSettings](https://developer.chrome.com/extensions/fontSettings) | 管理字体中的字体Microsoft Edge。 |
...
*  用户必须使用 MICROSOFT 帐户Microsoft Edge MSA 帐户 (或) Azure Active Directory帐户登录。 `chrome.identity.getProfileUserInfo` 如果用户使用本地 Active Directory Microsoft Edge登录，API 将返回电子邮件和 `null` ID 值。

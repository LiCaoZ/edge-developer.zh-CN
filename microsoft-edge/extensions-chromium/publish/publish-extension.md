---
description: 将Microsoft Edge (Chromium) 扩展发布到Microsoft Edge加载项网站
...
> [!NOTE]
> 如果在提交或注册过程中遇到任何问题，请将支持票证提交到扩展"新建支持[][ExtensionsSupportForm]请求["或][MailtoExtDevSupportMicrosoftCom]发送电子邮件到 ext_dev_support@microsoft.com。  

...
ms.date: 02/02/2022
ms.openlocfilehash: 938c1e47dcc6c5b2d44ee56b4ef64428e2e4c7a7
ms.sourcegitcommit: d753bc98ca50acdcdb7a8bf911af3465d3228058
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2022
ms.locfileid: "12465126"
---
...
| **JavaScript Profiler** 工具 | 此工具已被性能工具和**内存****工具取代**。 | [JavaScript 探查器工具](javascript-profiler/javascript-profiler-tool.md) |
| **图层** 工具 | **Layers 工具**表示 3D 空间中的网页。  **图层工具**基本上已替换为 **3D 视图**工具。 | [层工具](layers/layers-tool.md) |
...
| **Source 地图 Monitor** 工具 | 使用 **Source 地图 Monitor** 工具监视源地图。 | [源地图监视器工具](source-maps-monitor/source-maps-monitor-tool.md) |
...
* [在实验性功能中，使用焦点模式](experimental-features/focus-mode.md)简化 _DevTools_。  在**焦点模式下**，**活动**栏是主工具栏的精简替换，而快速视图列表是****"箱"工具栏上的选项卡的替换。

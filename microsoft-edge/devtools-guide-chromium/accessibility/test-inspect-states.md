...
ms.openlocfilehash: 3e70ae2f1b252346685fe2aa7927bc7ff9b39efb
ms.sourcegitcommit: 0eca205728eeca1bd54b3ca34dfc81ec57cf16d8
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/08/2021
ms.locfileid: "12082832"
---
...
1.  选择 DevTools 左上角的"检查 **\ (** 检查器图标 \) "按钮，以便该图标以蓝色图标 (![ ](../media/inspect-icon.msft.png) 突出显示) 。

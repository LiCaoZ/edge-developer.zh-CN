...
ms.openlocfilehash: 262c6ca2cea0e5c4f0fb44271ac9a28ca677b60a
ms.sourcegitcommit: 54f9566aa935fb853215c9b6f995fa0c98f3261f
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/19/2021
ms.locfileid: "12103368"
---
# <a name="microsoft-edge-developer-tools-overview"></a>Microsoft Edge开发人员工具概述

在安装Microsoft Edge，不仅会获取浏览器，还可以获取开发人员工具，从而提供检查、调试甚至创建 Web 项目的强大方法。  浏览器附带的开发人员工具部分基于 Chromium开放源代码项目中的工具，因此您可能已经熟悉了其中一些工具。  开发人员Microsoft Edge工具也称为 `Microsoft Edge DevTools` ，或只是 `DevTools` 。
...
*  或者，在 macOS (上的 `F12` `Ctrl` + `Shift` + `I` Windows/Linux `Command` + `Option` + `I`) 或 (按) 。
...
1.  在 **"DevTools** 相对于扩展坞侧页面的放置 ** (，) ** 布局选项。
...
*   自定义键盘 **快捷方式**。  例如，若要在 DevTools 中使用相同的快捷方式（如 Visual Studio Code 中一样，**** 请选择"从预设  >  **Visual Studio Code"。**
    ...
    :::image type="content" source="./media/devtools-intro-match-keys.msft.png" alt-text="所有键盘快捷方式的屏幕截图，以及要与键盘快捷方式匹配的菜单Visual Studio Code。":::
...
若要预览[DevTools][DevtoolsGuideWhatsNew202102Devtools]中的最新功能，请[下载Microsoft Edge Canary，][MicrosoftedgeinsiderDownload]该版本为夜间生成。

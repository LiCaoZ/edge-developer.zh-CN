...
ms.date: 04/01/2022
ms.openlocfilehash: b40161444efecd8b9dc59e91c2bf56d03a233eb7
ms.sourcegitcommit: e33dc94c1a64cb6a7b5c40ca6886fefa6865c9d0
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/14/2022
ms.locfileid: "12514899"
---
...
![DevTools 使用焦点模式试验在自己的窗口中取消连接。](media/focus-mode.png)
...
1. 单击 **“试验** ”并向下滚动到 **“焦点模式** ”复选框。
   ...
   如果选中 **焦点模式** 复选框，则已启用焦点模式。 选择或清除复选框以启用或禁用焦点模式：

   ![DevTools 中的设置页显示“试验”选项卡，向下滚动到“焦点模式”复选框。](media/focus-mode-pref.png)
...
**活动栏**在焦点模式下对齐，DevTools 停靠：

![活动栏在焦点模式下对齐，DevTools 已停靠。](media/focus-mode-docked.png)

**活动栏**在焦点模式下对齐，DevTools 在单独的窗口中弹出：

![活动栏在焦点模式下对齐，DevTools 在单独的窗口中弹出。](media/focus-mode-undocked.png)
...
![默认的 DevTools 工具栏问题和控制台消息指示器。](media/devtools-toolbar-message-indicator.png)

在焦点模式下，此计数器已被删除。 相反，小型指示器会覆盖 **问题** 和 **控制台** ，以显示消息是否已由相应的工具报告：
...
![焦点模式下的“快速视图”列表，其中选择了一个工具，并在底部窗格中打开。](media/focus-mode-quick-view.png)
...
![焦点模式下的菜单。](media/focus-mode-menu.png)

### <a name="help-links"></a>帮助链接

“ **帮助** ”菜单包含指向 DevTools 文档和发行说明的链接，以及一个向团队发送反馈的按钮：

![焦点模式下的“帮助”菜单。](media/focus-mode-help.png)

这些链接和按钮以前嵌套在默认用户界面的 **“自定义”和“控制 DevToolsHelp** > ”下。****
...
![焦点模式下的“更多工具”菜单](media/focus-mode-more-tools.png)

单击 **“更多工具** (**+**) 列出所有可用工具。 选择工具会将其固定到 **活动栏**。 默认情况下，每次打开 DevTools 时都会显示它。

如果 **活动栏** 中没有足够的空间来显示所有固定的工具，某些工具可能会溢出到 **“更多工具** ”菜单中：

![当窗口更短时，焦点模式下的“更多工具”菜单会导致某些图标显示在菜单中，而不是活动栏中](media/focus-mode-overflow-tools.png)

若要从 **活动栏**中取消固定工具，请右键单击该工具，然后 **从活动栏中选择“删除**”：

![要从活动栏中取消固定工具的右键单击菜单。](media/focus-mode-remove-tool.png)
...
以下屏幕截图并排显示 **网络** 工具和 **控制台** 工具：

![焦点模式，顶部有网络工具，底部是控制台工具。](media/focus-mode-quick-view-tool.png)
...
![焦点模式下的“活动栏位置”菜单。](media/focus-mode-activity-bar-location.png)
...
当 DevTools 在自己的窗口中取消连接时，水平 **活动栏** 会显示一些带有工具图标和名称的选项卡，以及一些仅带有图标的选项卡：

![具有水平活动栏的焦点模式。](media/focus-mode-horizontal.png)

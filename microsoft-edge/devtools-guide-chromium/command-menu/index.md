...
命令菜单提供了一种快速的方式，Microsoft Edge开发人员工具 UI 和完成常见任务，例如[禁用 JavaScript][JavascriptDisable]。  你可能熟悉命令Microsoft Visual Studio代码中的类似功能，这是命令菜单的原始灵感。 [][VisualStudioCodeUICommandPalette]  

...
要在 Chromium 开源代码项目中查看此功能的历史记录，请参阅问题 [1107766](https://crbug.com/1107766)。
...
要在 Chromium 开源代码项目中查看此功能的历史记录，请参阅问题 [1139615](https://crbug.com/1139615)。
...
例如，**网络** 工具以前在标签中使用 `kB`，但在计算中使用 `KiB`。  您的反馈表明这种前后矛盾导致混淆。  要在 Chromium 开源代码项目中查看此功能的历史记录，请参阅问题 [1035309](https://crbug.com/1035309)。

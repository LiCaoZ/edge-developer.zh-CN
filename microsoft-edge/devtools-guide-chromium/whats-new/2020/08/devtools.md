...
ms.openlocfilehash: 2edc244799518f9b3914cf280b9fb258c71a54c5
ms.sourcegitcommit: 1c5bc4695c976805fb5acbdac3350414bf79582d
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/12/2021
ms.locfileid: "11976586"
---
...
:::row:::
   ...
   :::column-end:::  
   :::column span="":::
      :::image type="complex" source="../../media/2020/08/console-table-beta-paste-visual-studio-code.msft.png" alt-text="表 85 或更早版本Microsoft Edge的控制台 API 输出粘贴到 Visual Studio Code" lightbox="../../media/2020/08/console-table-beta-paste-visual-studio-code.msft.png":::
...
" **属性** "窗格已返回。  它在[84 Microsoft Edge弃用][DevtoolsWhatsnew200205DevtoolsDeprecationPropertiesPaneElementsPanel]。  开发人员Microsoft Edge团队和 Chrome DevTools 团队正在计划针对检查元素属性的改进。  
...
DevTools 现在始终显示与原始网络请求相同的资源类型，当发生重定向 `/ Redirect` \ (**** HTTP 状态代码 302\) 附加到 Type 列值。  
...
[DevtoolsConsoleApiTable]: ../../../console/api.md#table "表 - 控制台 API |Microsoft Docs"  
...
[CR1051466]: https://crbug.com/1051466 "在 DevTools | 中支持 COOP/COEP 调试Chromium Bug"  
...
[CR1103316]: https://crbug.com/1103316 "元素搜索不解析Node (突出显示文本等) 第一次搜索结果搜索|Chromium Bug"  
...
[CR1107766]："显示有关框架树树中由 https://crbug.com/1107766 &quot;window.open () &quot;生成的帧|Chromium Bug"  
